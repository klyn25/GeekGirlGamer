<?php
	...
	$contrast = '#c8b290';
	$font = '#fff';
	$background = 'url(../images/girlyzombie/girlyzombiebackground.gif)';
	$header = 'url(../images/girlyzombie/girlyzombieheader2.gif)';
	$logo = 'url(../images/girlyzombie/girlyzombielogo.png)';
